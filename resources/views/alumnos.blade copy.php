...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.0.2/css/bootstrap.min.css" integrity="sha512-3nmKnQaZg3q1M2ae8z6DTwU5rC/W6xITL6drYp6WJZbwl1Eky9UahQkNl29WrU5r5U5F6NG5vO18C+jidN/g+w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
</head>
...
<body>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.0.2/js/bootstrap.min.js" integrity="sha512-lpF5V7P5fLhFaV7y+H5Yk67J0D5fr5SQ7Vcc34X/hGWv0Lmwe0pqgAA7m+G5DXdQHcnGkl/4adQ7x4LZtF+3tA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        <form action="alumnos" method="POST" id="form-insert2">
            <h2 class="text">Formulario de Insertar</h2>
            @csrf
            <input type="text" name="nombre" placeholder="Nombre">
            <input type="text" name="apellido" placeholder="Apellidos">
