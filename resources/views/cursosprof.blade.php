...
<div class="info">
    <div class="infodiv">
        ...
        <p>En esta sección, tendrás la posibilidad de visualizar todos los cursos en los cuales estás asignado como
            docente. Al hacer clic en uno de ellos, se desplegará una lista detallada de las asignaturas que impartes en
    ...
    <div class="infodiv">
        ...
        <p>Cuando selecciones una asignatura de un curso en particular, tendrás acceso a una tabla que presenta de
            manera organizada todas las ausencias registradas de los estudiantes matriculados en dicha clase. Además,
            podrás visualizar el porcentaje de faltas de cada estudiante y determinar si se encuentra en situación de
            suspensión debido a las mismas. Asimismo, es importante destacar que se ofrece la opción de visualizar las
