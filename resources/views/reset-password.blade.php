...
<head>
    ...
    {{-- ESTILOS --}}
    <link rel="stylesheet" href="{!! asset('css/stylespassword.css') !!}">
</head>
            ...
            <form method="post" action="{{ route('update-password') }}">
                ...
                <div class="relative">
                    ...
                    <input type="password" id="password" name="password" id="floating_filled"
                        ...
                        placeholder=" " />
                    <label for="password"
                        class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-grey-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Recuperar
                        Contraseña</label>
                </div>
